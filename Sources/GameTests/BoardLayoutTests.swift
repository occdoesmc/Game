...
final class BoardLayoutTests: XCTestCase {
    ...
    func testBoardButtonsAreAlignedHorizontally() {
        XCTAssertEqual(buttonAt(x: 0, y: 0).frame.minY, buttonAt(x: 1, y: 0).frame.minY)
        XCTAssertEqual(buttonAt(x: 0, y: 1).frame.minY, buttonAt(x: 1, y: 1).frame.minY)
        XCTAssertEqual(buttonAt(x: 0, y: 2).frame.minY, buttonAt(x: 1, y: 2).frame.minY)
        XCTAssertEqual(buttonAt(x: 0, y: 3).frame.minY, buttonAt(x: 1, y: 3).frame.minY)
        XCTAssertEqual(buttonAt(x: 0, y: 4).frame.minY, buttonAt(x: 1, y: 4).frame.minY)
        XCTAssertEqual(buttonAt(x: 0, y: 5).frame.minY, buttonAt(x: 1, y: 5).frame.minY)

        XCTAssertEqual(buttonAt(x: 1, y: 0).frame.minY, buttonAt(x: 2, y: 0).frame.minY)
        XCTAssertEqual(buttonAt(x: 1, y: 1).frame.minY, buttonAt(x: 2, y: 1).frame.minY)
        XCTAssertEqual(buttonAt(x: 1, y: 2).frame.minY, buttonAt(x: 2, y: 2).frame.minY)
        XCTAssertEqual(buttonAt(x: 1, y: 3).frame.minY, buttonAt(x: 2, y: 3).frame.minY)
        XCTAssertEqual(buttonAt(x: 1, y: 4).frame.minY, buttonAt(x: 2, y: 4).frame.minY)
        XCTAssertEqual(buttonAt(x: 1, y: 5).frame.minY, buttonAt(x: 2, y: 5).frame.minY)

        XCTAssertEqual(buttonAt(x: 2, y: 0).frame.minY, buttonAt(x: 3, y: 0).frame.minY)
        XCTAssertEqual(buttonAt(x: 2, y: 1).frame.minY, buttonAt(x: 3, y: 1).frame.minY)
        XCTAssertEqual(buttonAt(x: 2, y: 2).frame.minY, buttonAt(x: 3, y: 2).frame.minY)
        XCTAssertEqual(buttonAt(x: 2, y: 3).frame.minY, buttonAt(x: 3, y: 3).frame.minY)
        XCTAssertEqual(buttonAt(x: 2, y: 4).frame.minY, buttonAt(x: 3, y: 4).frame.minY)
        XCTAssertEqual(buttonAt(x: 2, y: 5).frame.minY, buttonAt(x: 3, y: 5).frame.minY)

        XCTAssertEqual(buttonAt(x: 3, y: 0).frame.minY, buttonAt(x: 4, y: 0).frame.minY)
        XCTAssertEqual(buttonAt(x: 3, y: 1).frame.minY, buttonAt(x: 4, y: 1).frame.minY)
        XCTAssertEqual(buttonAt(x: 3, y: 2).frame.minY, buttonAt(x: 4, y: 2).frame.minY)
        XCTAssertEqual(buttonAt(x: 3, y: 3).frame.minY, buttonAt(x: 4, y: 3).frame.minY)
        XCTAssertEqual(buttonAt(x: 3, y: 4).frame.minY, buttonAt(x: 4, y: 4).frame.minY)
        XCTAssertEqual(buttonAt(x: 3, y: 5).frame.minY, buttonAt(x: 4, y: 5).frame.minY)

        XCTAssertEqual(buttonAt(x: 4, y: 0).frame.minY, buttonAt(x: 5, y: 0).frame.minY)
        XCTAssertEqual(buttonAt(x: 4, y: 1).frame.minY, buttonAt(x: 5, y: 1).frame.minY)
        XCTAssertEqual(buttonAt(x: 4, y: 2).frame.minY, buttonAt(x: 5, y: 2).frame.minY)
        XCTAssertEqual(buttonAt(x: 4, y: 3).frame.minY, buttonAt(x: 5, y: 3).frame.minY)
        XCTAssertEqual(buttonAt(x: 4, y: 4).frame.minY, buttonAt(x: 5, y: 4).frame.minY)
        XCTAssertEqual(buttonAt(x: 4, y: 5).frame.minY, buttonAt(x: 5, y: 5).frame.minY)

        XCTAssertEqual(buttonAt(x: 5, y: 0).frame.minY, buttonAt(x: 6, y: 0).frame.minY)
        XCTAssertEqual(buttonAt(x: 5, y: 1).frame.minY, buttonAt(x: 6, y: 1).frame.minY)
        XCTAssertEqual(buttonAt(x: 5, y: 2).frame.minY, buttonAt(x: 6, y: 2).frame.minY)
        XCTAssertEqual(buttonAt(x: 5, y: 3).frame.minY, buttonAt(x: 6, y: 3).frame.minY)
        XCTAssertEqual(buttonAt(x: 5, y: 4).frame.minY, buttonAt(x: 6, y: 4).frame.minY)
        XCTAssertEqual(buttonAt(x: 5, y: 5).frame.minY, buttonAt(x: 6, y: 5).frame.minY)
    }

    func testBoardButtonsAreAlignedVertically() {
        XCTAssertEqual(buttonAt(x: 0, y: 0).frame.minX, buttonAt(x: 0, y: 1).frame.minX)
        XCTAssertEqual(buttonAt(x: 0, y: 1).frame.minX, buttonAt(x: 0, y: 2).frame.minX)
        XCTAssertEqual(buttonAt(x: 0, y: 2).frame.minX, buttonAt(x: 0, y: 3).frame.minX)
        XCTAssertEqual(buttonAt(x: 0, y: 3).frame.minX, buttonAt(x: 0, y: 4).frame.minX)
        XCTAssertEqual(buttonAt(x: 0, y: 4).frame.minX, buttonAt(x: 0, y: 5).frame.minX)

        XCTAssertEqual(buttonAt(x: 1, y: 0).frame.minX, buttonAt(x: 1, y: 1).frame.minX)
        XCTAssertEqual(buttonAt(x: 1, y: 1).frame.minX, buttonAt(x: 1, y: 2).frame.minX)
        XCTAssertEqual(buttonAt(x: 1, y: 2).frame.minX, buttonAt(x: 1, y: 3).frame.minX)
        XCTAssertEqual(buttonAt(x: 1, y: 3).frame.minX, buttonAt(x: 1, y: 4).frame.minX)
        XCTAssertEqual(buttonAt(x: 1, y: 4).frame.minX, buttonAt(x: 1, y: 5).frame.minX)

        XCTAssertEqual(buttonAt(x: 2, y: 0).frame.minX, buttonAt(x: 2, y: 1).frame.minX)
        XCTAssertEqual(buttonAt(x: 2, y: 1).frame.minX, buttonAt(x: 2, y: 2).frame.minX)
        XCTAssertEqual(buttonAt(x: 2, y: 2).frame.minX, buttonAt(x: 2, y: 3).frame.minX)
        XCTAssertEqual(buttonAt(x: 2, y: 3).frame.minX, buttonAt(x: 2, y: 4).frame.minX)
        XCTAssertEqual(buttonAt(x: 2, y: 4).frame.minX, buttonAt(x: 2, y: 5).frame.minX)

        XCTAssertEqual(buttonAt(x: 3, y: 0).frame.minX, buttonAt(x: 3, y: 1).frame.minX)
        XCTAssertEqual(buttonAt(x: 3, y: 1).frame.minX, buttonAt(x: 3, y: 2).frame.minX)
        XCTAssertEqual(buttonAt(x: 3, y: 2).frame.minX, buttonAt(x: 3, y: 3).frame.minX)
        XCTAssertEqual(buttonAt(x: 3, y: 3).frame.minX, buttonAt(x: 3, y: 4).frame.minX)
        XCTAssertEqual(buttonAt(x: 3, y: 4).frame.minX, buttonAt(x: 3, y: 5).frame.minX)

        XCTAssertEqual(buttonAt(x: 4, y: 0).frame.minX, buttonAt(x: 4, y: 1).frame.minX)
        XCTAssertEqual(buttonAt(x: 4, y: 1).frame.minX, buttonAt(x: 4, y: 2).frame.minX)
        XCTAssertEqual(buttonAt(x: 4, y: 2).frame.minX, buttonAt(x: 4, y: 3).frame.minX)
        XCTAssertEqual(buttonAt(x: 4, y: 3).frame.minX, buttonAt(x: 4, y: 4).frame.minX)
        XCTAssertEqual(buttonAt(x: 4, y: 4).frame.minX, buttonAt(x: 4, y: 5).frame.minX)

        XCTAssertEqual(buttonAt(x: 5, y: 0).frame.minX, buttonAt(x: 5, y: 1).frame.minX)
        XCTAssertEqual(buttonAt(x: 5, y: 1).frame.minX, buttonAt(x: 5, y: 2).frame.minX)
        XCTAssertEqual(buttonAt(x: 5, y: 2).frame.minX, buttonAt(x: 5, y: 3).frame.minX)
        XCTAssertEqual(buttonAt(x: 5, y: 3).frame.minX, buttonAt(x: 5, y: 4).frame.minX)
        XCTAssertEqual(buttonAt(x: 5, y: 4).frame.minX, buttonAt(x: 5, y: 5).frame.minX)

        XCTAssertEqual(buttonAt(x: 6, y: 0).frame.minX, buttonAt(x: 6, y: 1).frame.minX)
        XCTAssertEqual(buttonAt(x: 6, y: 1).frame.minX, buttonAt(x: 6, y: 2).frame.minX)
        XCTAssertEqual(buttonAt(x: 6, y: 2).frame.minX, buttonAt(x: 6, y: 3).frame.minX)
        XCTAssertEqual(buttonAt(x: 6, y: 3).frame.minX, buttonAt(x: 6, y: 4).frame.minX)
        XCTAssertEqual(buttonAt(x: 6, y: 4).frame.minX, buttonAt(x: 6, y: 5).frame.minX)
    }
